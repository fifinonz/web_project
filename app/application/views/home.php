<div id="layerslider-container-fw">
	<div id="layerslider" style="width: 100%; height: 530px; margin: 0px auto; ">
		...
		<div class="ls-slide" data-ls="transition3d:12;timeshift:-1000;">			
			<img src="http://images.webinane.com/ll/slider2.jpg" class="ls-bg" alt="Slide background">
		...
		<div class="ls-slide" data-ls="transition3d:35;timeshift:-1000;">			
			<img src="http://images.webinane.com/ll/slider3.jpg" class="ls-bg" alt="Slide background">
		...
		<div class="ls-slide" data-ls="transition3d:75;timeshift:-1000;">			
			<img src="http://images.webinane.com/ll/slider4.jpg" class="ls-bg" alt="Slide background">
		 ...
		 <div class="ls-slide" data-ls="transition3d:63;timeshift:-1000;">			
			<img src="<?php echo base_url();?>assets/images/slider5.jpg" class="ls-bg" alt="Slide background">
		...
		<div class="ls-slide" data-ls="transition3d:63;timeshift:-1000;">			
			<img src="<?php echo base_url();?>assets/images/slider6.jpg" class="ls-bg" alt="Slide background">
			<div class="ls-l slide-icon" style="top:70px; left:50%;"  data-ls="scalexin:0;scaleyin:0;durationin:1000;delayin:400;easingin:easeOutQuart;fadein:false;easingout:easeInQuart;rotatein:-800deg;" ><img src="<?php echo base_url();?>assets/images/slide6-icon.png" alt="" /></div>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="causes-image">
										<img src="<?php echo base_url();?>assets/images/our-causes1.jpg" alt="thumb1" />
								...
								<div class="col-md-4">
									<div class="causes-image">
										<img src="<?php echo base_url();?>assets/images/our-causes2.jpg" alt="thumb1" />
										<div class="cause-heading">
											<h3>Donate and give clean water</h3>
											<p>We needed to collect: <span><i>$</i>29,000</span> </p>
										</div>
								...
								<div class="col-md-4">
									<div class="causes-image">
										<img src="<?php echo base_url();?>assets/images/our-causes3.jpg" alt="thumb1" />
											<div class="cause-heading">
			...
			<div class="slideshow">
				<ul class="slides">
					<li>
						...
						<img src="<?php echo base_url();?>assets/images/testimonials1.jpg" alt="thumb1" />
					...
					<li>
						<div class="carusal-image-thumb">
						<img src="<?php echo base_url();?>assets/images/testimonials2.jpg" alt="thumb1" />
						<strong>Marry Williams,</strong><span class="carusal-image-thumb-name"> CEO </span>
						</div>
						<p>Fusce nec arcu eget nunc scelerisque pharetra eget vel metus. Curabitur a orci et nulla gravida laoreet. Pellentesque dictum ipsum nec placerat dignissim. Vivamus porta pellentesque libero, sit amet placerat mauris iaculis non. Nullam eleifend, eros eget facilisis adipiscing, nibh mi vehicula tellus, non</p>
					</li><!-- Messgae2 -->
					<li>
						<div class="carusal-image-thumb">
						<img src="<?php echo base_url();?>assets/images/testimonials3.jpg" alt="thumb1" />
						<strong>Marry Williams,</strong><span class="carusal-image-thumb-name"> CEO </span>
						</div>
						<p>Fusce nec arcu eget nunc scelerisque pharetra eget vel metus. Curabitur a orci et nulla gravida laoreet. Pellentesque dictum ipsum nec placerat dignissim. Vivamus porta pellentesque libero, sit amet placerat mauris iaculis non. Nullam eleifend, eros eget facilisis adipiscing, nibh mi vehicula tellus, non</p>
					</li><!-- Messgae3 -->
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="carusal-slider">
						...
						<div id="carousel">
							<div id="news1">
								<div class="row">
									<div class="col-md-6 desc">
										...
										<p>Lorem ipsum dolor sit amet, consectetu pisei ing elit. Pellente sque mi tellus, fringilla intedi dumdi vitae, tempor id lorem. Nunc aliquett ndun conse iquat. Lorem ipsum dolor sit amet, consectet uos pisei ing elit. Pellentesque miteds llus, intedidum vitae, tempor idorem. Nunc aliquettndunt consni equat. Nunc aliquett ndun conse iquat. </p>
									</div>
									<div class="col-md-6">
										<div class="image">
											<img src="<?php echo base_url();?>assets/images/recent-news1.jpg" alt="" />
							...
							<div id="news2">
								<div class="row">
									...
									<div class="col-md-6">
										<div class="image">
											<img src="<?php echo base_url();?>assets/images/recent-news2.jpg" alt="" />
											<a class="html5lightbox" href="http://player.vimeo.com/video/31943945?color=ffffff" title="This Is a Demo Video">
											<span><i class="icon-play"></i></span>
											</a>
										</div>
							...
							<div id="news3">
								<div class="row">
									...
									<div class="col-md-6">
										<div class="image">
											<img src="<?php echo base_url();?>assets/images/recent-news3.jpg" alt="" />
											<a class="html5lightbox" href="http://player.vimeo.com/video/31943945?color=ffffff" title="This Is a Demo Video">
											<span><i class="icon-play"></i></span>
											</a>
										</div>
					...
					<div id="thumbs-wrapper">
						<div id="thumbs">
							<a href="#news1" class="selected"><img src="<?php echo base_url();?>assets/images/recent-news1-thumb.jpg" alt="" /><span class="carusal-our-news">Emergency Supplies</span></a>
							<a href="#news2"><img src="<?php echo base_url();?>assets/images/recent-news2-thumb.jpg" alt="" /><span class="carusal-our-news">Safety Quiz and Tips </span></a>
							<a href="#news3"><img src="<?php echo base_url();?>assets/images/recent-news3-thumb.jpg" alt="" /><span class="carusal-our-news">Safety Quiz and Tips </span></a>
							<a href="#news4"><img src="<?php echo base_url();?>assets/images/recent-news1-thumb.jpg" alt="" /><span class="carusal-our-news">Safety Quiz and Tips </span></a>
							<a href="#news5"><img src="<?php echo base_url();?>assets/images/recent-news2-thumb.jpg" alt="" /><span class="carusal-our-news">Safety Quiz and Tips </span></a>
							<a href="#news6"><img src="<?php echo base_url();?>assets/images/recent-news3-thumb.jpg" alt="" /><span class="carusal-our-news">Safety Quiz and Tips </span></a>
						</div><!-- Selectors -->
			...
			<div class="col-md-6 pull-right">
				<div class="sec-heading">
					<h2><strong>Our Welfare</strong> Projects</h2>
				</div>
							...
							<div class="row">
								...
								<div class="col-md-7">
									<div class="project-detail">
										<a>Fighting Pollution</a>
										<p>Vivamus tincidunt faucib metus. It into elemenitum rhoncus element metus.</p>			
									</div>
								</div>
							</div>
						</div>
